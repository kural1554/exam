...
export const mockExams: Exam[] = [
  ...
  },
  {
    ...
    examTitle: "Technology",
    category: "AI",
    subCategory: "Machine Learning",
    childCategory: "Deep Learning",
    numberOfQuestions: 25,
  ...
  },
  {
    ...
    childCategory: "GOTS Certified",
    numberOfQuestions: 22,
    image: { src: 'https://placehold.co/400x225', hint: 'chemistry beakers' },
    color: 'bg-sky-500',
  ...
  },
  {
    ...
    category: "AI",
    subCategory: "Machine Learning",
    childCategory: "Natural Language Processing",
    numberOfQuestions: 30,
    image: { src: 'https://placehold.co/400x225', hint: 'computer code' },
    color: 'bg-violet-700',
  ...
  },
  {
    ...
    subCategory: "Recycled Materials",
    childCategory: "Paper Products",
    numberOfQuestions: 28,
    image: { src: 'https://placehold.co/400x225', hint: 'stock market chart' },
    color: 'bg-green-700',
    ...
    childCategory: "Current Events",
    numberOfQuestions: 20,
    image: { src: "https://placehold.co/400x225", hint: "geometric shapes" },
    color: "bg-blue-500",
  ...
  },
  {
    ...
    subCategory: "Europe",
    childCategory: "Mediterranean",
    numberOfQuestions: 25,
    image: { src: "https://placehold.co/400x225", hint: "planet earth" },
    color: "bg-green-500",
  ...
  },
  {
    ...
    childCategory: "Historical",
    numberOfQuestions: 30,
    image: { src: "https://placehold.co/400x225", hint: "roman colosseum" },
    color: "bg-yellow-500",
  ...
  },
  {
    ...
    childCategory: "Arts & Culture",
    numberOfQuestions: 20,
    image: { src: "https://placehold.co/400x225", hint: "theater stage" },
    color: "bg-purple-500",
  ...
  },
  {
    ...
    childCategory: "Deep Learning",
    numberOfQuestions: 25,
    image: { src: 'https://placehold.co/400x225', hint: 'electromagnetism diagram' },
    color: 'bg-red-500',
  ...
  },
  {
    ...
    childCategory: "GOTS Certified",
    numberOfQuestions: 22,
    image: { src: 'https://placehold.co/400x225', hint: 'molecule structure' },
    color: 'bg-sky-500',
  ...
  },
  {
    ...
    childCategory: "Natural Language Processing",
    numberOfQuestions: 30,
    image: { src: 'https://placehold.co/400x225', hint: 'data structure diagram' },
    color: 'bg-violet-700',
    ...
    childCategory: "Paper Products",
    numberOfQuestions: 28,
    image: { src: 'https://placehold.co/400x225', hint: 'global economy map' },
    color: 'bg-green-700',
    ...
    childCategory: "Current Events",
    numberOfQuestions: 20,
    image: { src: "https://placehold.co/400x225", hint: "calculus graph" },
    color: "bg-blue-500",
  ...
  },
  {
    ...
    category: "Fitness",
    subCategory: "Yoga",
    childCategory: "Advanced Yoga",
    numberOfQuestions: 25,
    image: { src: "https://placehold.co/400x225", hint: "dna strand" },
    color: "bg-green-500",
...
export const mockQuestions: Question[] = [
  ...
  { 
  ...
  },
   {
    id: 's3',
    examId: 'sci-101',
    questionText: 'Based on the image, which part of the cell is labeled with the letter A?',
    image: {
      src: 'https://placehold.co/400x300/EAB308/white?text=Cell+Diagram',
      alt: 'A diagram of an animal cell with different parts labeled.',
      hint: 'animal cell diagram'
    },
    ...
    translations: {
        hindi: {
            questionText: 'चित्र के आधार पर, कोशिका के किस भाग को A अक्षर से চিহ্নিত किया गया है?',
            options: ['नाभिक', 'कोशिकाद्रव्य', 'कोशिका झिल्ली', 'माइटोकॉन्ड्रियन'],
        },
    },
  },
  // History Questions
...
export const mockNewChildCategories: NewChildCategory[] = [
    { id: 1, name: 'GOTS Certified', rowOrder: 0},
    { id: 2, name: 'Current Events', rowOrder: 1},
    { id: 3, name: 'Paper Products', rowOrder: 2},
    { id: 4, name: 'Mediterranean', rowOrder: 3},
    { id: 5, name: 'Beginner Yoga', rowOrder: 4},
    { id: 6, name: 'Deep Learning', rowOrder: 5},
    { id: 7, name: 'Historical', rowOrder: 6},
    { id: 8, name: 'Arts & Culture', rowOrder: 7},
    { id: 9, name: 'Natural Language Processing', rowOrder: 8},
    { id: 10, name: 'Advanced Yoga', rowOrder: 9},
];
